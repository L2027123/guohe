import{a as v,j as e,b as _,c as q}from"./index-lLTTX94F.js";import{b as K,r as f}from"./react-vendor-DSYpD63Q.js";import{g as O,i as J,aa as H,m as U,n as L,T as M,L as Z,Z as W,A as G,R as Q}from"./lucide-BI_aoc8b.js";import"./zustand-DOacgZDb.js";function V(c){if(!c)return c;let t=c.trim();t.startsWith("```")&&(t=t.replace(/^```(?:json)?\n?/,"").replace(/\n?```$/,""));const o=t.indexOf("{"),n=t.lastIndexOf("}");o>=0&&n>o&&(t=t.substring(o,n+1)),t=t.replace(/,(\s*[}\]])/g,"$1"),t=t.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F]/g,"");let d=!1,r="",g="";for(let u=0;u<t.length;u++){const i=t[u],x=t[u-1];if(!d&&(i==='"'||i==="'")){d=!0,r=i,g+='"';continue}if(d&&i===r&&x!=="\\"){d=!1,g+='"';continue}if(d&&i===`
